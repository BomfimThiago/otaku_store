  ...
  return (
    <section className="relative mb-8 overflow-hidden rounded-2xl bg-gradient-to-r from-neon-violet via-neon-pink to-neon-cyan">
      ...
      <div className="relative flex flex-col gap-3 px-6 py-12 sm:px-10 sm:py-16">
        <p className="text-sm font-semibold uppercase tracking-wide text-neon-cyan">OtakuVerso</p>
        <h2 className="max-w-xl font-display text-3xl font-bold text-fg sm:text-4xl">
        ...
        <Link
          to="/?category=figures"
          className="mt-4 inline-flex w-fit items-center rounded-lg bg-ink-950 px-5 py-3 text-sm font-semibold text-fg shadow-neon transition hover:brightness-110"
        >
          Ver figures
        </Link>
      </div>
